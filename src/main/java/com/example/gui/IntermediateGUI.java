    ...
    public static void createAndShowGUI() {
        ...
        startButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                try {
                    if (i < QuizLogic.getQuestionsByDifficulty("INTERMEDIATE", "questions").size() && answer
                            .equals(QuizLogic.getQuestionsByDifficulty("INTERMEDIATE", "answer").get(i).toString())) {
                        score++;
                    }
                    i++;
                    if (i < QuizLogic.getQuestionsByDifficulty("INTERMEDIATE", "questions").size() + 1) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                "You have completed the Intermediate Round!\nYour score is: " + score + "/6");
