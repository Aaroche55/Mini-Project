...
public class StatsIntermediateGUI {
    ...
    public static void createAndShowGUI(){
         ...
         //Heading label
         JLabel headingLabel = new JLabel("Intermediate");
         ...
         table.setValueAt(MeanCalculator.getUsersMeanByMode(loginGUI.getUsername(), "intermediate") + "%", 1, 1);
         table.setValueAt(MeanCalculator.getAllUsersMeanByMode("intermediate") + "%", 1, 2);
         table.setValueAt("Median", 2, 0);
         table.setValueAt(MedianCalculator.getUsersMedianByMode(loginGUI.getUsername(), "intermediate") + "%", 2, 1);
         table.setValueAt(MedianCalculator.getAllUsersMedianByMode("intermediate") + "%", 2, 2);
         table.setValueAt("Standard Deviation", 3, 0);
         table.setValueAt(StandardDeviationCalculator.getUsersStdDevByMode(loginGUI.getUsername(), "intermediate"), 3, 1);
         table.setValueAt(StandardDeviationCalculator.getAllUsersStdDevByMode("intermediate"), 3, 2);
