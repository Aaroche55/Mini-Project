...
public class StatsQuickfireGUI {
    ...
    public static void createAndShowGUI(){
        ...
        //Heading label
        JLabel headingLabel = new JLabel("Quickfire");
        headingLabel.setFont(new Font("Gotham Rounded", Font.BOLD, 24));
        headingLabel.setForeground(Color.BLACK);
        headingLabel.setBounds(235, 10, 400, 30); // Set coordinates and size
        ...
        table.setValueAt(MeanCalculator.getUsersMeanByMode(loginGUI.getUsername(), "quickfire") + "%", 1, 1);
        table.setValueAt(MeanCalculator.getAllUsersMeanByMode("quickfire") + "%", 1, 2);
        table.setValueAt("Median", 2, 0);
        table.setValueAt(MedianCalculator.getUsersMedianByMode(loginGUI.getUsername(), "quickfire") + "%", 2, 1);
        table.setValueAt(MedianCalculator.getAllUsersMedianByMode("quickfire") + "%", 2, 2);
        table.setValueAt("Standard Deviation", 3, 0);
        table.setValueAt(StandardDeviationCalculator.getUsersStdDevByMode(loginGUI.getUsername(), "quickfire"), 3, 1);
        table.setValueAt(StandardDeviationCalculator.getAllUsersStdDevByMode("quickfire"), 3, 2);
