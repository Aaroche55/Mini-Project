...
public class StatsAdvancedGUI {
    ...
    public static void createAndShowGUI(){
         ...
         //Heading label
         JLabel headingLabel = new JLabel("Advanced");
         ...
         table.setValueAt(MeanCalculator.getUsersMeanByMode(loginGUI.getUsername(), "advanced") + "%", 1, 1);
         table.setValueAt(MeanCalculator.getAllUsersMeanByMode("advanced") + "%", 1, 2);
         table.setValueAt("Median", 2, 0);
         table.setValueAt(MedianCalculator.getUsersMedianByMode(loginGUI.getUsername(), "advanced") + "%", 2, 1);
         table.setValueAt(MedianCalculator.getAllUsersMedianByMode("advanced") + "%", 2, 2);
         table.setValueAt("Standard Deviation", 3, 0);
         table.setValueAt(StandardDeviationCalculator.getUsersStdDevByMode(loginGUI.getUsername(), "advanced"), 3, 1);
         table.setValueAt(StandardDeviationCalculator.getAllUsersStdDevByMode("advanced"), 3, 2);
