...
public class StatsLeaderboardGUI {
    ...
    public static void createAndShowGUI(){
        ...
        JTable table = new JTable(Leaderboard.return_users().size(),3);
        table.setBounds(100, 100, 400, 200);
        table.setValueAt("1st", 0, 0);
        
        for (int i = 0; i < Leaderboard.return_users().size(); i++) {

            table.setValueAt(i+1, i, 0);
            table.setValueAt(Leaderboard.createLeaderboard().get(i).getKey(), i, 1);
            table.setValueAt(Leaderboard.createLeaderboard().get(i).getValue(), i, 2);
        }
